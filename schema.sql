-- ============================================================
-- KPI SYSTEM — CLOUD SQL (MySQL 8.0)
...
CREATE TABLE periods (
  id         INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  name       VARCHAR(50) NOT NULL,       -- e.g. "Juni 2026"
  year       YEAR NOT NULL,
...
('Juni 2026', 2026, 6, '2026-06-01', '2026-06-30', 1),
('Mei 2026', 2026, 5, '2026-05-01', '2026-05-31', 0);
...
(1, 3, 1, 4, 50.00, 4.5),     -- Sari: CSAT 50%
(1, 4, 1, 3, 50.00, 100),     -- Budi S: Bug Rate 50%
(1, 4, 1, 5, 50.00,  15),     -- Budi S: Code Review 50%
(1, 5, 1, 4, 50.00, 4.5),     -- Dewi: CSAT 50%
(1, 5, 1, 1, 50.00,  50);     -- Dewi: Tiket 50%

INSERT INTO tasks (period_id, employee_id, weight_id, title, target, status) VALUES
(1, 2, 1, 'Penyelesaian Tiket',   100,      'in_progress'),
(1, 2, 2, 'Code Review',           20,      'in_progress'),
(1, 2, 3, 'Dokumentasi API',       10,      'pending'),
(1, 3, 4, 'Target Revenue',    50000000,    'in_progress'),
(1, 3, 5, 'Kepuasan Pelanggan',     4.5,    'in_progress'),
(1, 4, 6, 'Bug Resolution',        100,     'in_progress'),
(1, 4, 7, 'Code Review',            15,     'pending'),
(1, 5, 8, 'Kepuasan Pelanggan',     4.5,    'pending'),
(1, 5, 9, 'Penyelesaian Tiket',     50,     'in_progress');
